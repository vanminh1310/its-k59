...
window.pageMapVehicleTracking = function ()
{
    ...
    var MapView = function ()
    {
        ...
        for (var i = 0; i <= 7; i++)
        {
            vehicleIcons.push(L.icon({ iconUrl: "/Projects/Web/Modules/Examples/CodeFun/MapVehicleTracking/icons/{0}.png".format(i), iconSize: [35,35] }));
            directionIcons.push(L.icon({ iconUrl: "/Projects/Web/Modules/Examples/CodeFun/MapVehicleTracking/icons/D{0}.png".format(i), iconSize: [10, 10] }));
        }
    ...
    L.tileLayer(myUrl, { maxZoom: 40, attribution: 'Code mô phỏng © <a href="http://sonpc20.com">Sonpc20.com</a>', id: 'mapbox/streets-v11', tileSize: 512, zoomOffset: -1 }).addTo(mapView.map);
